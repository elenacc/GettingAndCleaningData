...
The previous dataset was obtained from UC Irvine Machine Learning repository and modified to combine test and trial data. Data vectors containing other measurements but Mean and Standard Deviations were deleted and the data was aggregated to describe the mean of each measurement per diferent activity and subject. Therefore the data contains the following variables:
